...
@section('content')
    ...
    <div x-data="{
        ...
        bukaDropdown() {
            ...
            this.search(); // ← langsung load hasil saat dropdown dibuka
        },
        ...
        <div class="flex items-center justify-between mb-5">
            <div>
                ...
                <p class="text-sm text-gray-400 dark:text-slate-500 mt-0.5">Tambah peserta baru untuk program
                    {{ $bantuan->nama }}</p>
            </div>
            <nav class="flex items-center gap-1.5 text-sm">
                ...
                <a href="{{ route('admin.bantuan.index') }}"
                    class="text-gray-400 dark:text-slate-500 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">Daftar
                    Program Bantuan</a>
                <svg class="w-3.5 h-3.5 text-gray-300 dark:text-slate-600" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                ...
                <a href="{{ route('admin.bantuan.show', $bantuan) }}"
                    class="text-gray-400 dark:text-slate-500 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors truncate max-w-[140px]">{{ $bantuan->nama }}</a>
                <svg class="w-3.5 h-3.5 text-gray-300 dark:text-slate-600" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
                        ...
                        <template x-if="openDrop">
                            <div class="absolute left-0 top-full mt-1 w-full z-50 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-xl shadow-xl overflow-hidden"
                                ...
                                <div class="p-2 border-b border-gray-100 dark:border-slate-700">
                                    <div class="relative">
                                        <input type="text" id="search-peserta-input" x-model="query"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                            ...
                            <div class="rounded-xl border border-emerald-200 dark:border-emerald-800 overflow-hidden">
                                ...
                                <div class="p-4 space-y-4">
                                    ...
                                    <div>
                                        <label for="no_kartu"
                                            class="block text-xs font-medium text-gray-600 dark:text-slate-400 uppercase tracking-wide mb-1.5">Nomor
                                            Kartu Peserta</label>
                                        <input type="text" id="no_kartu" name="no_kartu"
                                            value="{{ old('no_kartu') }}" placeholder="Nomor Kartu Peserta"
                                    ...
                                    <div>
                                        <label
                                            class="block text-xs font-medium text-gray-600 dark:text-slate-400 uppercase tracking-wide mb-1.5">Gambar
                                            Kartu Peserta</label>
                                        ...
                                        <p class="text-xs text-gray-400 dark:text-slate-500 mt-1">Kosongkan jika tidak
                                            ingin mengunggah gambar</p>
                                        @error('gambar_kartu')
                                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        <label for="kartu_nik"
                                            class="block text-xs font-medium text-gray-600 dark:text-slate-400 uppercase tracking-wide mb-1.5">NIK
                                    ...
                                    <div>
                                        <label for="kartu_nama"
                                            class="block text-xs font-medium text-gray-600 dark:text-slate-400 uppercase tracking-wide mb-1.5">Nama
                                            <span class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="kartu_tempat_lahir"
                                            class="block text-xs font-medium text-gray-600 dark:text-slate-400 uppercase tracking-wide mb-1.5">Tempat
                                            Lahir</label>
                                    ...
                                    <div>
                                        <label for="kartu_tanggal_lahir"
                                            class="block text-xs font-medium text-gray-600 dark:text-slate-400 uppercase tracking-wide mb-1.5">Tanggal
                                            Lahir</label>
                                    ...
                                    <div>
                                        <label for="kartu_alamat"
                                            class="block text-xs font-medium text-gray-600 dark:text-slate-400 uppercase tracking-wide mb-1.5">Alamat</label>
                                    ...
                                    <div>
                                        <label for="keterangan"
                                            class="block text-xs font-medium text-gray-600 dark:text-slate-400 uppercase tracking-wide mb-1.5">Keterangan</label>

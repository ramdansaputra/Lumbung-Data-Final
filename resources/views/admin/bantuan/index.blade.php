    ...
    <div x-data="{
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 overflow-hidden">
            ...
            <div class="flex items-center gap-2 px-5 pt-5 pb-4 flex-wrap">
                ...
                <form method="POST" action="{{ route('admin.bantuan.clean-participants') }}" id="form-bersihkan"
                    style="display: inline;">
                    @csrf
                    <button type="button"
                        @click="confirm('Apakah Anda yakin ingin menghapus semua data peserta dari semua program bantuan? Tindakan ini tidak dapat dibatalkan.') && document.getElementById('form-bersihkan').submit()"

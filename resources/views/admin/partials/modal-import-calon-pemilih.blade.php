{{--
PARTIAL: resources/views/admin/partials/modal-import-calon-pemilih.blade.php

CARA PAKAI — include sekali di halaman calon pemilih:
@include('admin.partials.modal-import-calon-pemilih')

CARA TRIGGER dari tombol:
<button type="button" @click="$dispatch('buka-modal-import-calon-pemilih')">Import Data</button>
--}}
...
<div x-data="{
        ...
        fileName: '',
        dragging: false,
    }" @buka-modal-import-calon-pemilih.window="show = true" x-show="show" x-transition.opacity
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden"
        ...
        <div class="flex items-center justify-between px-6 py-5 border-b border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="font-bold text-gray-900 text-base">Import Data Calon Pemilih</h3>
        ...
        {{-- Body --}}
        <form action="{{ route('admin.calon-pemilih.import') }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <label for="import-file-upload-calon-pemilih"
                    ...
                    @dragover.prevent="dragging = true" @dragleave.prevent="dragging = false" @drop.prevent="
                        ...
                        if (f) { fileName = f.name; $refs.fileInputCalonPemilih.files = $event.dataTransfer.files; }
                    ">
                    ...
                    <input id="import-file-upload-calon-pemilih" x-ref="fileInputCalonPemilih" name="file" type="file" accept=".csv,.xls,.xlsx"
            ...
            <div class="flex items-start gap-3 p-3 bg-blue-50 rounded-xl border border-blue-100">
                ...
                <div class="flex-1">
                    <p class="text-xs text-blue-800">Pastikan format file sesuai template.</p>
                    <a href="{{ route('admin.calon-pemilih.template') }}"

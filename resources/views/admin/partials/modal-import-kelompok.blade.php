{{--
PARTIAL: resources/views/admin/partials/modal-import-kelompok.blade.php

CARA PAKAI — include sekali di halaman anggota kelompok:
@include('admin.partials.modal-import-kelompok', ['kelompok' => $kelompok])

CARA TRIGGER dari tombol:
<button type="button" @click="$dispatch('buka-modal-import-kelompok')">Import Data</button>
--}}
...
<div x-data="{
        ...
        fileName: '',
        dragging: false,
    }" @buka-modal-import-kelompok.window="show = true" x-show="show" x-transition.opacity
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden"
        ...
        <div class="flex items-center justify-between px-6 py-5 border-b border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="font-bold text-gray-900 text-base">Import Anggota Kelompok</h3>
        ...
        {{-- Body --}}
        <form action="{{ route('admin.kelompok.anggota.import', $kelompok) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <label for="import-file-upload-kelompok"
                    ...
                    @dragover.prevent="dragging = true" @dragleave.prevent="dragging = false" @drop.prevent="
                        ...
                        if (f) { fileName = f.name; $refs.fileInputKelompok.files = $event.dataTransfer.files; }
                    ">
                    ...
                    <input id="import-file-upload-kelompok" x-ref="fileInputKelompok" name="file" type="file" accept=".csv,.xls,.xlsx"
            ...
            <div class="flex items-start gap-3 p-3 bg-blue-50 rounded-xl border border-blue-100">
                ...
                <div class="flex-1">
                    ...
                    <a href="{{ route('admin.kelompok.anggota.template', $kelompok) }}"

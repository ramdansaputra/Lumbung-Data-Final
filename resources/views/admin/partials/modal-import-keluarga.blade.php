{{-- 
PARTIAL: resources/views/admin/partials/modal-import-keluarga.blade.php

CARA PAKAI — include sekali di halaman keluarga:
@include('admin.partials.modal-import-keluarga')
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden"
        ...
        <div class="flex items-center justify-between px-6 py-5 border-b border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="font-bold text-gray-900 text-base">Import Data Keluarga</h3>
        ...
        <form action="{{ route('admin.keluarga.import') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-2 gap-3">
                    <label
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-0.5">No.KK yang sudah ada dilewati</p>
                        </div>
                    </label>
                    <label
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-0.5">No.KK yang sama diperbarui</p>
                        </div>
                    </label>
                </div>
            </div>
            ...
            <div class="flex items-start gap-3 p-3 bg-blue-50 rounded-xl border border-blue-100">
                ...
                <div class="flex-1">
                    ...
                    <a href="{{ route('admin.keluarga.template') }}"
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <button type="submit"
                    ...
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 12a3 3 0 11-6 0 3 3 0 016 0zM9 19l3 3m0 0l3-3m-3 3V10" />
                    </svg>
                    Import Data
                </button>
            </div>

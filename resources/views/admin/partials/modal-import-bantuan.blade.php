{{--
PARTIAL: resources/views/admin/partials/modal-import-bantuan.blade.php

CARA PAKAI — include sekali di halaman peserta bantuan:
@include('admin.partials.modal-import-bantuan', ['bantuan' => $bantuan])

CARA TRIGGER dari tombol:
<button type="button" @click="$dispatch('buka-modal-import-bantuan')">Import Data</button>
--}}
...
<div x-data="{
        ...
        fileName: '',
        dragging: false,
    }" @buka-modal-import-bantuan.window="show = true" x-show="show" x-transition.opacity
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden"
        ...
        <div class="flex items-center justify-between px-6 py-5 border-b border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="font-bold text-gray-900 text-base">Import Peserta Bantuan</h3>
        ...
        {{-- Body --}}
        <form action="{{ route('admin.bantuan.peserta.import', $bantuan) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <label for="import-file-upload-bantuan"
                    ...
                    @dragover.prevent="dragging = true" @dragleave.prevent="dragging = false" @drop.prevent="
                        ...
                        if (f) { fileName = f.name; $refs.fileInputBantuan.files = $event.dataTransfer.files; }
                    ">
                    ...
                    <input id="import-file-upload-bantuan" x-ref="fileInputBantuan" name="file" type="file" accept=".csv,.xls,.xlsx"
            ...
            <div class="flex items-start gap-3 p-3 bg-blue-50 rounded-xl border border-blue-100">
                ...
                <div class="flex-1">
                    ...
                    <a href="{{ route('admin.bantuan.peserta.template', $bantuan) }}"

    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 overflow-hidden">
        ...
        <div class="px-5 pb-4">
            <form method="GET" action="{{ route('admin.analisis.index') }}" id="form-filter" class="space-y-3">
                    ...
                    <div class="relative w-52" x-data="{
                        ...
                        <div x-show="open"
                            ...
                            <ul class="max-h-52 overflow-y-auto py-1">
                                ...
                                <li x-show="filtered.length === 0" class="px-3 py-2 text-sm text-gray-400 dark:text-slate-500 text-center">
                                    Tidak ditemukan
                                </li>
                            </ul>
                        </div>
                ...
                <div class="flex flex-wrap items-center justify-between gap-3 border-t border-gray-100 dark:border-slate-700/50 pt-3">
                        ...
                        <td class="px-4 py-4 text-center">
                            @if($item->google_form_id)
                                ...
                                @if($item->last_sync_at)
                                    <p class="text-xs text-gray-400 dark:text-slate-500 mt-1">{{ $item->last_sync_at->diffForHumans() }}</p>
                                @endif
                            @else
                                <span class="text-gray-400 dark:text-slate-500 text-sm">-</span>
                            @endif

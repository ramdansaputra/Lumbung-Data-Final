...
@section('content')
    ...
    <div class="px-4 py-3 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-900/50">
        <form method="GET" action="{{ route('admin.penduduk') }}" id="form-filter"
            ...
            <input type="hidden" name="status_hidup" id="val-status_hidup" value="{{ request('status_hidup') }}">
        ...
        <form method="GET" action="{{ route('admin.penduduk') }}" class="flex items-center gap-2">
            ...
            <div class="relative group">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="kata kunci pencarian"
                    maxlength="50" title="Masukkan kata kunci untuk mencari (maksimal 50 karakter)"
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors"
                        ...
                        <td class="px-3 py-3">
                            <button class="btn-aksi" data-penduduk-id="{{ $p->id }}"
                                ...
                                <svg style="width:13px;height:13px;flex-shrink:0;" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="px-6 py-4 max-h-[65vh] overflow-y-auto space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div x-data="{
                                ...
                                <label class="block text-xs font-semibold text-gray-600 dark:text-slate-400 mb-1.5">Status
                                    Perkawinan</label>
                                <button type="button" @click="open=!open" @keydown.escape="open=false"
                                    class="w-full flex items-center justify-between px-3 py-2 border rounded-lg text-sm bg-white dark:bg-slate-700 transition-colors"
                                    :class="open ? 'border-emerald-500 ring-2 ring-emerald-500/20' :
                            ...
                            <div x-data="{
                                ...
                                <label class="block text-xs font-semibold text-gray-600 dark:text-slate-400 mb-1.5">Jenis
                                    Kelamin</label>
                                <button type="button" @click="open=!open" @keydown.escape="open=false"
                                    class="w-full flex items-center justify-between px-3 py-2 border rounded-lg text-sm bg-white dark:bg-slate-700 transition-colors"
                                    :class="open ? 'border-emerald-500 ring-2 ring-emerald-500/20' :
                            ...
                            <div x-data="{
                                ...
                                <label class="block text-xs font-semibold text-gray-600 dark:text-slate-400 mb-1.5">Cara
                                    KB</label>
                                <button type="button" @click="open=!open" @keydown.escape="open=false"
                                    class="w-full flex items-center justify-between px-3 py-2 border rounded-lg text-sm bg-white dark:bg-slate-700 transition-colors"
                                    :class="open ? 'border-emerald-500 ring-2 ring-emerald-500/20' :
                            ...
                            <div x-data="{
                                ...
                                <label class="block text-xs font-semibold text-gray-600 dark:text-slate-400 mb-1.5">BPJS
                            ...
                            <div x-data="{
                                ...
                                <label class="block text-xs font-semibold text-gray-600 dark:text-slate-400 mb-1.5">Warga
                                    Negara</label>
                                <button type="button" @click="open=!open" @keydown.escape="open=false"
                                    class="w-full flex items-center justify-between px-3 py-2 border rounded-lg text-sm bg-white dark:bg-slate-700 transition-colors"
                                    :class="open ? 'border-emerald-500 ring-2 ring-emerald-500/20' :
                            ...
                            <div x-data="{
                                ...
                                <label class="block text-xs font-semibold text-gray-600 dark:text-slate-400 mb-1.5">Sakit
                                    Menahun</label>
                                <button type="button" @click="open=!open" @keydown.escape="open=false"
                                    class="w-full flex items-center justify-between px-3 py-2 border rounded-lg text-sm bg-white dark:bg-slate-700 transition-colors"
                                    :class="open ? 'border-emerald-500 ring-2 ring-emerald-500/20' :
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <span x-show="selectedNiks.length === 0" class="text-xs text-gray-400 italic">Belum
                                        ada NIK yang dipilih</span>
                                </div>
                            </div>
                        </div>
                    </div>

...
@section('content')
    ...
    <div class="flex items-center justify-between mb-5">
        <div>
            <h2 class="text-lg font-bold text-gray-800 dark:text-slate-100">Data Anggota Lembaga Desa</h2>
            <p class="text-xs text-gray-400 dark:text-slate-500 mt-0.5">Formulir penambahan anggota {{ $lembaga->nama }}</p>
        </div>
    ...
    <form action="{{ route('admin.lembaga-desa.anggota.store', $lembaga->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="flex items-start gap-5">
            ...
            <div
                    ...
                    <div class="p-5 grid grid-cols-2 gap-x-5 gap-y-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <select name="penduduk_id" id="penduduk_id" required
                                    ...
                                    class="w-full px-3 py-2 border rounded-lg text-sm
                                      ...
                                      {{ $errors->has('penduduk_id') ? 'border-red-400 bg-red-50 dark:bg-red-900/10' : 'border-gray-300 dark:border-slate-600' }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="no_anggota" value="{{ old('no_anggota') }}"
                                   placeholder="Nomor Anggota" maxlength="50"
                        ...
                        <div>
                            ...
                            <select name="jabatan" required
                                    class="w-full px-3 py-2 border rounded-lg text-sm
                                      bg-white dark:bg-slate-700 text-gray-800 dark:text-slate-200
                                      focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 outline-none transition-all
                                      {{ $errors->has('jabatan') ? 'border-red-400 bg-red-50 dark:bg-red-900/10' : 'border-gray-300 dark:border-slate-600' }}">
                                ...
                                @foreach(['Ketua','Wakil Ketua','Sekretaris','Bendahara','Anggota'] as $jab)
                                    <option value="{{ strtoupper($jab) }}"
                                        {{ old('jabatan') == strtoupper($jab) ? 'selected' : '' }}>
                                        {{ strtoupper($jab) }}
                                    </option>
                                @endforeach
                            </select>
                ...
                {{-- ════════ INFO PENDUDUK (Read-only, auto-fill) ════════ --}}
                <div class="border-b border-gray-100 dark:border-slate-700">
                    <div class="bg-cyan-50 dark:bg-cyan-900/20 border-b border-cyan-100 dark:border-cyan-800/40 px-5 py-2">
                    ...
                    <div class="p-5 grid grid-cols-2 gap-x-5 gap-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="info_tempat" readonly placeholder="Otomatis terisi"
                                   class="w-full px-3 py-2 border border-gray-200 dark:border-slate-600 rounded-lg text-sm
                                     ...
                                     placeholder-gray-300 dark:placeholder-slate-600 cursor-not-allowed">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="text" id="info_tgl" readonly placeholder="Tanggal lahir"
                                       class="flex-1 px-3 py-2 border border-gray-200 dark:border-slate-600 rounded-lg text-sm
                                         bg-gray-50 dark:bg-slate-700/50 text-gray-500 dark:text-slate-400
                                         placeholder-gray-300 dark:placeholder-slate-600 cursor-not-allowed">
                                <input type="text" id="info_umur" readonly placeholder="Umur"
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" id="info_alamat" readonly placeholder="Otomatis terisi saat memilih penduduk"
                                   class="w-full px-3 py-2 border border-gray-200 dark:border-slate-600 rounded-lg text-sm
                                     bg-gray-50 dark:bg-slate-700/50 text-gray-500 dark:text-slate-400
                                     placeholder-gray-300 dark:placeholder-slate-600 cursor-not-allowed">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="info_pendidikan" readonly placeholder="Otomatis terisi"
                                   class="w-full px-3 py-2 border border-gray-200 dark:border-slate-600 rounded-lg text-sm
                                     bg-gray-50 dark:bg-slate-700/50 text-gray-500 dark:text-slate-400
                                     placeholder-gray-300 dark:placeholder-slate-600 cursor-not-allowed">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="text" id="info_wn" readonly placeholder="WN"
                                       class="flex-1 px-3 py-2 border border-gray-200 dark:border-slate-600 rounded-lg text-sm
                                         bg-gray-50 dark:bg-slate-700/50 text-gray-500 dark:text-slate-400
                                         placeholder-gray-300 dark:placeholder-slate-600 cursor-not-allowed">
                                <input type="text" id="info_agama" readonly placeholder="Agama"
                                       class="flex-1 px-3 py-2 border border-gray-200 dark:border-slate-600 rounded-lg text-sm
                                         bg-gray-50 dark:bg-slate-700/50 text-gray-500 dark:text-slate-400
                                         placeholder-gray-300 dark:placeholder-slate-600 cursor-not-allowed">
                            </div>
                ...
                <div class="border-b border-gray-100 dark:border-slate-700">
                    ...
                    <div class="p-5 grid grid-cols-2 gap-x-5 gap-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="nomor_sk_jabatan" value="{{ old('nomor_sk_jabatan') }}"
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wide mb-1.5">
                                Masa Jabatan <span class="font-normal normal-case text-gray-400">(Usia/Periode)</span>
                            </label>
                        ...
                        <div>
                            ...
                            <input type="text" name="nomor_sk_pengangkatan" value="{{ old('nomor_sk_pengangkatan') }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_sk_pengangkatan" value="{{ old('tanggal_sk_pengangkatan') }}"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg text-sm
                                     bg-white dark:bg-slate-700 text-gray-800 dark:text-slate-200
                                     focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 outline-none transition-all">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="nomor_sk_pemberhentian" value="{{ old('nomor_sk_pemberhentian') }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_sk_pemberhentian" value="{{ old('tanggal_sk_pemberhentian') }}"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg text-sm
                                     bg-white dark:bg-slate-700 text-gray-800 dark:text-slate-200
                                     focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 outline-none transition-all">
                        </div>
                    ...
                    <div class="p-5">
                        ...
                        <textarea name="keterangan" rows="4" maxlength="500"
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg text-sm
                                    bg-white dark:bg-slate-700 text-gray-800 dark:text-slate-200
                                    placeholder-gray-300 dark:placeholder-slate-500
                                    focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 outline-none transition-all resize-vertical">{{ old('keterangan') }}</textarea>
                    </div>
                </div>

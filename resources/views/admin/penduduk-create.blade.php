...
<div class="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-6">
    ...
    <form id="penduduk-form" method="POST" action="{{ route('admin.penduduk.store') }}">
        @csrf
            ...
            <div class="flex-1">
                <div class="flex gap-3">
                    ...
                    <select name="hubungan_keluarga"
                        ...
                        <option value="{{ $val }}" {{ old('hubungan_keluarga') == $val ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="flex-1">
                <div class="flex gap-3">
                    ...
                    <select name="hubungan_rumah_tangga"
                        ...
                        <option value="{{ $val }}" {{ old('hubungan_rumah_tangga') == $val ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
            </div>

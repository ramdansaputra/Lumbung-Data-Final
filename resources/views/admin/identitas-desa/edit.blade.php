...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-slate-100">Edit Identitas Desa</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-slate-400">Perbarui informasi identitas dan profil desa</p>
        </div>
        <a href="{{ route('admin.identitas-desa.index') }}"
            class="inline-flex items-center gap-2 px-5 py-2.5 bg-white dark:bg-slate-700 hover:bg-gray-50 dark:hover:bg-slate-600 text-gray-700 dark:text-slate-200 text-sm font-semibold rounded-xl shadow-sm border border-gray-200 dark:border-slate-600 transition-all duration-200 hover:shadow-md">

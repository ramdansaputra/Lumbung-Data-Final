...
<style>
    ...
    @media print {
        ...
        #kk-print-area, #kk-print-area * { visibility: visible !important; }
        #kk-print-area {
    ...
    .kk-address-row .sep   { color: #6b7280; }
    .kk-address-row .value { color: #111; }
            ...
            <div style="overflow-x:auto;">
                <table class="kk-table">
                    ...
                    <tbody>
                        @php
                            $shdkMap = [
                                1 => 'KEPALA KELUARGA', 2 => 'SUAMI / ISTRI', 3 => 'ANAK',
                                4 => 'MENANTU', 5 => 'CUCU', 6 => 'ORANG TUA',
                                7 => 'MERTUA', 8 => 'FAMILI LAIN', 9 => 'PEMBANTU', 10 => 'LAINNYA',
                            ];
                        @endphp
                        @forelse($keluarga->anggota as $i => $anggota)
                            <tr>
                                ...
                                <td style="white-space:nowrap; text-align:center;">
                                    {{ $anggota->tanggal_perkawinan
                                        ? \Carbon\Carbon::parse($anggota->tanggal_perkawinan)->format('d-m-Y')
                                        : '.' }}
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="9" style="text-align:center; padding:20px; color:#6b7280; font-style:italic;">
                                    Belum ada data
                                </td>
                            </tr>
                        @endforelse

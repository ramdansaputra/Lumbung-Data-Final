            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="fw-bold text-dark mb-1">
                        <i class="fas fa-hard-hat text-primary me-2"></i>Buku Administrasi Pembangunan
                    </h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Buku Administrasi Pembangunan</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="list-menu">
                ...
                {{-- MENU 1: Rencana Pembangunan (SUDAH DIHUBUNGKAN) --}}
                <a href="{{ route('admin.buku-administrasi.pembangunan.rencana.index') }}" class="list-menu-item">
                    <i class="fas fa-drafting-compass"></i>
                    <span>Buku Rencana Kerja Pembangunan</span>
                </a>

                {{-- MENU 2: Kegiatan Pembangunan (PLACEHOLDER) --}}
                <a href="#" class="list-menu-item">
                    <i class="fas fa-tasks"></i>
                    <span>Buku Kegiatan Pembangunan</span>
                </a>

                {{-- MENU 3: Inventaris Pembangunan (PLACEHOLDER) --}}
                <a href="#" class="list-menu-item">
                    <i class="fas fa-clipboard-list"></i>
                    <span>Buku Inventaris Hasil-Hasil Pembangunan</span>
                </a>

                {{-- MENU 4: Kader Pemberdayaan (PLACEHOLDER) --}}
                <a href="#" class="list-menu-item">
                    <i class="fas fa-hands-helping"></i>
                    <span>Buku Kader Pemberdayaan Masyarakat</span>
                </a>
                    ...
                    <table class="history-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Menambahkan rencana pembangunan jalan desa RT 03 tahun 2026</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Memperbarui progres pembangunan Balai Desa tahap II</td>
                                <td>
                                    <div class="user-badge">

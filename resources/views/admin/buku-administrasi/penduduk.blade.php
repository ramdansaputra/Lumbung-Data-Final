            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="fw-bold text-dark mb-1">
                        <i class="fas fa-users text-primary me-2"></i>Buku Administrasi Penduduk
                    </h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Buku Administrasi Penduduk</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="list-menu">
                ...
                <a href="#" class="list-menu-item">
                    ...
                    <span>Buku Mutasi Penduduk Desa</span>
                </a>
                <a href="#" class="list-menu-item">
                ...
                <a href="#" class="list-menu-item">
                    ...
                    <span>Buku Penduduk Sementara</span>
                </a>
                <a href="#" class="list-menu-item">
                    <i class="fas fa-id-card"></i>
                    <span>Buku KTP dan KK</span>
                </a>
            </div>
        </div>
    </div>
                    ...
                    <table class="history-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Buku Induk Penduduk</td>
                                <td>Menambahkan data penduduk baru atas nama Siti Rahayu</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Buku Mutasi Penduduk Desa</td>
                                <td>Memperbarui data mutasi pindah keluar atas nama Budi Santoso</td>
                                <td>
                                    <div class="user-badge">
                            ...
                            <tr>
                                ...
                                <td>Menghapus data penduduk sementara duplikat tanggal 10 Feb 2026</td>
                                <td>
                                    <div class="user-badge">
                                        <div class="avatar">SK</div>
                                        Sekretaris Desa
                            ...
                            <tr>
                                ...
                                <td>Mencatat permohonan KTP baru No. 045/KTP/II/2026 atas nama Andi Wijaya</td>
                                <td>
                                    <div class="user-badge">
                                        <div class="avatar">AD</div>
                                        Admin Desa
                            ...
                            <tr>
                                ...
                                <td>Revisi data rekapitulasi penduduk bulan Februari 2026</td>
                                <td>
                                    <div class="user-badge">

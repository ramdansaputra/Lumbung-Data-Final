...
<section class="py-20 bg-gray-50 overflow-hidden relative">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        {{-- Animasi Zoom-in pada Icon Beranda (Pusat Peta) --}}
        <div class="flex justify-center mb-16" data-aos="zoom-in" data-aos-duration="800">
        ...
        {{-- Garis Penghubung dengan animasi lebar --}}
        <div class="relative max-w-5xl mx-auto mb-12 hidden lg:block" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            {{-- Kolom 3: Legal (Fade Left) --}}
            <div class="flex flex-col items-center" data-aos="fade-left" data-aos-delay="800">
                <div class="lg:hidden h-8 w-1 bg-gray-300 mb-4"></div>
...
{{-- Section Bawah dengan animasi Zoom-out --}}
<section class="py-16 bg-white border-t border-gray-100" data-aos="zoom-out" data-aos-offset="100">
...
{{-- Assets AOS (Hanya tambahkan jika belum ada di layout app) --}}

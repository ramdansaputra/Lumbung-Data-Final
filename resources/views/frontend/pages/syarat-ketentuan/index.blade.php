...
{{-- Tambahkan library AOS di head via stack/push jika ada, atau cukup di sini --}}
@section('content')
...
<section class="py-12 lg:py-20 bg-gray-50 relative">
    <div class="container mx-auto px-4">
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            {{-- Sidebar dengan animasi fade-right --}}
            <div class="lg:w-1/4" data-aos="fade-right" data-aos-delay="200">
            ...
            {{-- Main Content dengan animasi fade-up --}}
            <div class="lg:w-3/4" data-aos="fade-up" data-aos-delay="400">
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 lg:p-12 relative overflow-hidden">
                    ...
                    <section id="pendahuluan" class="mb-16 scroll-mt-32 relative z-10 observer-section" data-aos="fade-up">
                    ...
                    <section id="penggunaan" class="mb-16 scroll-mt-32 relative z-10 observer-section" data-aos="fade-up">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3 pb-4 border-b border-gray-100">
                        ...
                        <div class="grid gap-4">
                            @foreach([
                                '1' => 'Website ini disediakan untuk tujuan informasi publik, pelayanan administrasi desa (surat menyurat online), dan transparansi pemerintahan.',
                                '2' => 'Anda setuju untuk menggunakan website ini hanya untuk tujuan yang sah dan tidak melanggar hukum atau peraturan yang berlaku.',
                                '3' => 'Dilarang keras melakukan upaya peretasan, penyebaran virus, atau tindakan lain yang dapat mengganggu kinerja atau keamanan sistem website desa.',
                                '4' => 'Untuk layanan yang membutuhkan data pribadi (seperti permohonan surat), Anda wajib memberikan data yang benar, akurat, dan terbaru.'
                            ] as $index => $text)
                            <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100 transition-all duration-300 hover:shadow-md hover:-translate-y-1" data-aos="fade-left" data-aos-delay="{{ $loop->index * 100 }}">
                                <span class="flex-shrink-0 w-6 h-6 rounded-full bg-emerald-500 text-white flex items-center justify-center font-bold text-xs mt-0.5">{{ $index }}</span>
                    ...
                    <section id="hak-cipta" class="mb-16 scroll-mt-32 relative z-10 observer-section" data-aos="fade-up">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3 pb-4 border-b border-gray-100">
                        ...
                        <div class="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-lg" data-aos="zoom-in">
                    ...
                    <section id="tanggung-jawab" class="mb-16 scroll-mt-32 relative z-10 observer-section" data-aos="fade-up">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3 pb-4 border-b border-gray-100">
                        ...
                        <ul class="space-y-3 pl-2">
                            ...
                            <li class="flex items-start gap-3 text-sm text-gray-600" data-aos="fade-left" data-aos-delay="{{ $loop->index * 100 }}">
                    ...
                    <section id="perubahan" class="scroll-mt-32 relative z-10 observer-section" data-aos="fade-up">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3 pb-4 border-b border-gray-100">
                        ...
                        <div class="bg-purple-50 rounded-2xl p-6 border border-purple-100 text-sm text-gray-600 leading-relaxed" data-aos="flip-up">
...
<style>
    ...
    /* Memastikan konten tidak hilang jika JS gagal load */
    [data-aos] {
        pointer-events: none;
    }
    .aos-animate {

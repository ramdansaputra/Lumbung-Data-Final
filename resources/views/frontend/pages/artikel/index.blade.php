...
<style>
    ...
    /* Staggered delays untuk grid artikel */
...
<section class="py-16 bg-gray-50 relative">
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            {{-- KOLOM UTAMA: LIST ARTIKEL --}}
            <div class="lg:w-2/3">

                {{-- Search & Filter --}}
                <div class="reveal-on-scroll sticky top-20 z-30 bg-gray-50/95 backdrop-blur-md py-4 -mx-4 px-4 mb-8 border-b border-gray-200 transition-all duration-300">
                    <div class="mb-4">
                ...
                @if($artikelList->count() > 0)
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                        @foreach($artikelList as $index => $artikel)
                            <div class="reveal-on-scroll delay-{{ ($index % 3) + 1 }} h-full">
                                <x-article-card
                                    :title="$artikel['title']"
                    ...
                    <div class="reveal-on-scroll mt-12 flex justify-center pb-8">
                    ...
                    <div class="mt-8 bg-gradient-to-br from-emerald-700 to-teal-800 rounded-2xl p-8 text-white relative overflow-hidden shadow-lg group">
                        ...
                        <div class="relative z-10 text-center">
                            ...
                            <p class="text-emerald-100 text-sm mb-6 leading-relaxed">
                                Jangan ragu untuk menghubungi perangkat desa jika Anda memiliki pertanyaan atau butuh bantuan.
                            </p>

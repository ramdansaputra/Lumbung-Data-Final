...
@section('description', 'Temukan produk dan usaha warga desa kami. Dukung ekonomi lokal dengan berbelanja dari lapak warga.')
...
<style>
    ...
    /* Staggered Delay untuk Grid (max 10 item per batch) */
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <div class="lg:w-2/3">
                ...
                {{-- Search Bar --}}
                <div class="reveal-on-scroll sticky top-20 z-30 bg-gray-50/95 backdrop-blur-md py-4 -mx-4 px-4 mb-8 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                    @foreach($lapakList as $index => $lapak)
                    <a href="{{ route('lapak.show', $lapak->slug) }}"
                        class="reveal-on-scroll delay-{{ ($index % 5) + 1 }} group bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md hover:border-emerald-100 transition-all duration-300">
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                                @if($lapak->telepon)
                                <div class="flex items-center gap-1.5 text-xs font-medium text-green-600 hover:text-green-700 transition">
                ...
                {{-- Pagination --}}
                <div class="reveal-on-scroll mt-4 flex justify-center pb-8">
                    {{ $lapakList->appends(request()->query())->links('pagination::tailwind') }}
                </div>

                @else
                {{-- Empty State --}}
                <div class="reveal-on-scroll text-center py-20 bg-white rounded-3xl border-2 border-dashed border-gray-200 mt-8">
            ...
            <div class="lg:w-1/3 space-y-8">
                ...
                {{-- Info Card --}}
                <div class="reveal-on-scroll bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                {{-- CTA Daftarkan Lapak --}}
                <div class="reveal-on-scroll bg-gradient-to-br from-emerald-700 to-teal-800 rounded-2xl p-8 text-white relative overflow-hidden shadow-lg group">
                    ...
                    <div class="relative z-10 text-center">
                        <div class="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center mx-auto mb-5 backdrop-blur-sm border border-white/20">
...
<script>
    (function() {
        ...
        // Cadangan jika ada sistem page load custom
